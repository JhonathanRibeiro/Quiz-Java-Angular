...
// // public interface RankingRepository extends JpaRepository<Resposta, Long> {
// // 	@Query("select distinct u.nome"+
...
// // 			"where"+
// // 		    "op_subsql.opcao_correta = 'SIM'"+
// // 			"and r3.usuario_id = r.usuario_id)")
// // 	List<Resposta> findByRanking();
// // }
